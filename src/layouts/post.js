            ...
            <Layout {...this.props}>
              <article className="post post-full">
                ...
                <div className="post-content inner-md">
                  ...
                  <img className="thumbnail" src={withPrefix(_.get(this.props, 'page.sectionImageWithText[0].image', null))} alt={_.get(this.props, 'page.sectionImageWithText[0].image', null)} />               
