            ...
            <Layout {...this.props}>
              <article className="post post-full">
                ...
                <div className="post-content inner-md">
                  ...
                  {markdownify(_.get(this.props, 'page.sectionImageWithText[1].image.title', null))}
                  ...
                  {htmlToReact(_.get(this.props, 'page.sectionImageWithText[2].heading', null))}
                  {markdownify(_.get(this.props, 'page.sectionImageWithText[2].text', null))}
                </div>
                )}
              </article>
            </Layout>
